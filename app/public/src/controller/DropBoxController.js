class DropBoxController {
    constructor() {
        ...
        this.btnNemFolder = document.querySelector("#btn-new-folder");
    ...
    connectFirebase() {
        //Configuração abaixo é criada cadastrando um Realtime Database no Firebase
        var firebaseConfig = {
            apiKey: "api_key",
    ...
    removeTask() {
        ...
        this.getSelection().forEach(li => {
            ...
            promises.push(new Promise((resolve, reject) => {
                ...
                } else if(file.type) { // não apagar undefined
    ...
    initEvents() {
        this.btnNemFolder.addEventListener('click', e => {
    ...
    getFirebaseRef(path) {
        ...
        return firebase.database().ref(path); //pega onde quer que salva no firebase
    }
    ...
    uploadProgress(event, file) {
        let timespent = Date.now() - this.startUploadTime; // quanto tempo falta
    ...
    openFolder() {
        if(this.lastFolder) this.getFirebaseRef(this.lastFolder).off('value'); // desliga o evento de escuta do firebase
        this.readFiles();
        this.renderNav();
    }
    ...
    renderNav() {
        ...
        // adiciona evento para renderizar a pasta clicada no breadcrumb
        this.navEl.querySelectorAll('a').forEach(a => {
            a.addEventListener('click', e => {
                e.preventDefault(); // não coloca a # na url
    ...
    initEventsLi(li) {
        ...
        li.addEventListener('click', e => {
            ...
            if(e.shiftKey) { // seleção quando segura o shift
            ...
            if(!e.ctrlKey) { // seleção quando segura o CTRL
